...
describe SchedulesController do
  ...
  def valid_attributes
    { :available => true, :doctor_id => 1, :time_slot => "8 am - 9 am" }
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved schedule as @schedule" do
        ...
        post :create, {:schedule => { "doctor_id" => "invalid value" }}, valid_session
        assigns(:schedule).should be_a_new(Schedule)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested schedule" do
        ...
        Schedule.any_instance.should_receive(:update_attributes).with({ "doctor_id" => "1" })
        put :update, {:id => schedule.to_param, :schedule => { "doctor_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the schedule as @schedule" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Schedule.any_instance.stub(:save).and_return(false)
        put :update, {:id => schedule.to_param, :schedule => { "doctor_id" => "invalid value" }}, valid_session
        assigns(:schedule).should eq(schedule)
      end
